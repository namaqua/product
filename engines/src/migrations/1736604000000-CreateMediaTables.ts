...
export class CreateMediaTables1736604000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_media_filename" ON "media" ("filename")`);
        await queryRunner.query(`CREATE INDEX "IDX_media_type" ON "media" ("type")`);
        await queryRunner.query(`CREATE INDEX "IDX_media_mimeType" ON "media" ("mimeType")`);
        await queryRunner.query(`CREATE INDEX "IDX_media_isDeleted" ON "media" ("isDeleted")`);
        await queryRunner.query(`CREATE INDEX "IDX_media_isActive" ON "media" ("isActive")`);
        await queryRunner.query(`CREATE INDEX "IDX_media_isPrimary" ON "media" ("isPrimary")`);
        await queryRunner.query(`CREATE INDEX "IDX_media_sortOrder" ON "media" ("sortOrder")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_product_media_mediaId" ON "product_media" ("mediaId")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "product_media" DROP CONSTRAINT "FK_product_media_productId"`);
        await queryRunner.query(`ALTER TABLE "product_media" DROP CONSTRAINT "FK_product_media_mediaId"`);

        // Drop indexes
        await queryRunner.query(`DROP INDEX "IDX_product_media_productId"`);
        await queryRunner.query(`DROP INDEX "IDX_product_media_mediaId"`);
        await queryRunner.query(`DROP INDEX "IDX_media_sortOrder"`);
        await queryRunner.query(`DROP INDEX "IDX_media_isPrimary"`);
        await queryRunner.query(`DROP INDEX "IDX_media_isActive"`);
        await queryRunner.query(`DROP INDEX "IDX_media_isDeleted"`);
