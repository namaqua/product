...
export default function Button({
  ...
  const variantClasses = {
    primary:
      'bg-navy-800 text-white hover:bg-navy-700 focus-visible:outline-navy-800 disabled:bg-navy-600',
    secondary:
    ...
    danger:
      'bg-danger-600 text-white hover:bg-danger-500 focus-visible:outline-danger-600 disabled:bg-danger-400',
    ghost: 'text-gray-700 hover:bg-gray-50 hover:text-gray-900 focus-visible:outline-gray-600',
    accent:
      'bg-accent-500 text-white hover:bg-accent-600 focus-visible:outline-accent-500 disabled:bg-accent-400 shadow-orange',
  };
